...
net start frp_service      rem 启动服务
sc query frp_service       rem 查看启动是否启动成功
net stop frp_service       rem 停止服务
sc delete frp_service      rem 删除服务
...
net start frp     rem 启动服务
sc delete frp     rem 删除服务
